...
- Each Pod will constantly run its own HTTP listener, which adds overhead.
...
We provide the [spin-containerd-shim-installer](https://github.com/spinframework/spin-containerd-shim-installer) Helm chart that provides an automated method to install and configure the containerd shim for Fermyon Spin in Kubernetes. Please see the [README](https://github.com/spinframework/spin-containerd-shim-installer/blob/main/README.md) in the installer repository for more information.
...
| [Spin](https://github.com/spinframework/spin/releases)              | [containerd-shim-spin-v1](https://github.com/deislabs/containerd-wasm-shims/releases) |
| ------------------------------------------------------------- | ------------------------------------------------------------------------------------- |
