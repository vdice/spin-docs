...
[extra]
canonical_url = "https://spinframework.com/v2/build"
...
If you generated the component from a supplied template, the `component.build` section should be set up correctly for you. You don't need to change or add anything.
